...
if DEBUG:
  U2F_APPID="https://db43-158-62-51-139.ngrok-free.app"    #URL For U2F
  FIDO_SERVER_ID=u"db43-158-62-51-139.ngrok-free.app"      # Server rp id for FIDO2, it the full domain of your project
else:
